...
class PauseMenu(State):
    ...
    def get_buttons(self):
        ...
        buttons = ButtonGroup()
        buttons.add(Button(410, 125, 'RESUME', font, resume_action, "#664747", "#826153"))
        buttons.add(Button(410, 165, 'SETTINGS', font, settings_action, "#664747", "#826153"))
        buttons.add(Button(410, 205, 'QUIT TO MENU', font, quit_action, "#664747", "#826153"))
        return buttons
